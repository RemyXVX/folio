...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const EMAILJS_SERVICE_ID = process.env.NEXT_EMAILJS_SERVICE_ID;
    const EMAILJS_TEMPLATE_ID = process.env.NEXT_EMAILJS_TEMPLATE_ID;
    const EMAILJS_PUBLIC_KEY = process.env.NEXT_EMAILJS_PUBLIC_KEY;
